...
describe('DimensionUtils', () => {
  ...
  describe('calculatePosition', () => {
    ...
    it('should return calculate position if side is provided', () => {
      ...
      expect(DimensionUtils.calculatePosition('right 10', 200, 400)).toEqual(
        190,
      );
      expect(DimensionUtils.calculatePosition('left 10%', 200, 400)).toEqual(
        40,
      );
      expect(DimensionUtils.calculatePosition('right 10%', 200, 400)).toEqual(
        160,
      );
      expect(DimensionUtils.calculatePosition('left 50%', 200, 400)).toEqual(
        200,
      );
      expect(DimensionUtils.calculatePosition('right 50%', 200, 400)).toEqual(
        0,
      );
